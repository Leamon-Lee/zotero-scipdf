...
queue-instructions = Click Verify for a human-verification item. Complete the challenge in the browser, wait until the paper page or PDF appears, and keep that page open while the plugin retries automatically. If it remains HTTP 0, download the PDF in the browser and drag it into Zotero.
